...
1. The coding assistant adds tool instructions to your request
1. The language model responds: "ReadFile: main.go"
1. The coding assistant reads the actual file and sends its contents back to the model
1. The language model provides a final answer based on the file contents
